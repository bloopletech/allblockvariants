...
public class SlabsGroupCreator {
    private final SlabCreator creator;

    public SlabsGroupCreator(ResourcePackBuilder builder) {
        this.creator = new SlabCreator(builder);
    }
