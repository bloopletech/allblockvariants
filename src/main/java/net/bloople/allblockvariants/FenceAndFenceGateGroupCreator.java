...
public class FenceAndFenceGateGroupCreator {
    private final FenceAndFenceGateCreator creator;

    public FenceAndFenceGateGroupCreator(ResourcePackBuilder builder) {
        this.creator = new FenceAndFenceGateCreator(builder);
    }

    public void create() {
        // Minerals
        creator.create(Blocks.STONE);
        creator.create(Blocks.COBBLESTONE);
        creator.create(Blocks.MOSSY_COBBLESTONE);
        creator.create(Blocks.POLISHED_GRANITE);
        creator.create(Blocks.POLISHED_DIORITE);
        creator.create(Blocks.POLISHED_ANDESITE);
        creator.create(Blocks.BRICKS);
        creator.create(Blocks.PRISMARINE);
        creator.create(Blocks.MOSSY_STONE_BRICKS);
        creator.create(Blocks.GRANITE);
        creator.create(Blocks.STONE_BRICKS);
        creator.create(Blocks.MUD_BRICKS);
        creator.create(Blocks.ANDESITE);
        creator.create(Blocks.RED_NETHER_BRICKS);
        creator.create(Blocks.SANDSTONE);
        creator.create(Blocks.END_STONE_BRICKS);
        creator.create(Blocks.DIORITE);
...
//            GLASS
        ...
        creator.create(Blocks.BLACKSTONE);
        creator.create(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS);
        creator.create(Blocks.CHISELED_POLISHED_BLACKSTONE);
        creator.create(Blocks.POLISHED_BLACKSTONE_BRICKS);
        creator.create(Blocks.POLISHED_BLACKSTONE);
        ...
        //MUD
        //DEEPSLATE
        creator.create(Blocks.COBBLED_DEEPSLATE);
        creator.create(Blocks.POLISHED_DEEPSLATE);
        creator.create(Blocks.DEEPSLATE_TILES);
        creator.create(Blocks.DEEPSLATE_BRICKS);
