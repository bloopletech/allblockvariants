...
class RedstoneLampThinSlabBlock(settings: Settings) : ThinSlabBlock(settings) {
    companion object {
    ...
    override fun getPlacementState(ctx: ItemPlacementContext): BlockState {
        return super.getPlacementState(ctx).with(LIT, ctx.world.isReceivingRedstonePower(ctx.blockPos))
    }
