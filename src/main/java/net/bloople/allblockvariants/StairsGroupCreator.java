...
public class StairsGroupCreator {
    private final StairsCreator creator;

    public StairsGroupCreator(ResourcePackBuilder builder) {
        this.creator = new StairsCreator(builder);
    }
